...
[IMPORTANT]
Il faut absolument mettre un mot de passe pour que cela fonctionne
...
Le plugin Sonos met aussi à disposition un panel qui rassemble tous vos Sonos. Disponible a partir du menu Accueil -> Sonos Controller : 
